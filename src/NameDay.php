...
class NameDay {
	 ...
	 * @return string
	 */
	public static function getByDateTime(\DateTime $dateTime): string {
	 ...
	 * @return string
	 */
	public static function getByTimestamp(int $timestamp): string {
	 ...
	 */
	public static function get(int $day, int $month): string {
		if (!isset(self::$list[$month][$day])) {
			throw new NameDayException("Name day not exists for $day:$month");
		}

		return self::$list[$month][$day];
	}
	...
	protected static $list = [
		...
		5 =>
			[
				...
				3 => 'Alexej',
				4 => 'Květoslav',
				5 => 'Klaudie, Květnové povstání českého lidu (1945)',
				6 => 'Radoslav',
				7 => 'Stanisla',
				8 => 'Den osvobození od fašismu (1945)',
				9 => 'Ctibor',
				10 => 'Blažena',
				11 => 'Svatava',
				12 => 'Pankrác',
		...
		7 =>
			[
				...
				6 => 'Upálení Mistra Jana Husa (1415)',
				7 => 'Bohuslava',
				8 => 'Nora',
				9 => 'Drahoslava',
				10 => 'Libuše, Amálie',
		...
		11 =>
			[
				...
				15 => 'Leopold',
				16 => 'Otmar',
				17 => 'Mahulena, Den boje studentů za svobodu a demokracii (1989)',
				18 => 'Romana',
				19 => 'Alžběta',
				20 => 'Nikola',
				21 => 'Albert',
